...
The template leaves Cloudflare custom domains, analytics, and object storage
disabled. Add only the optional integrations you intend to operate. Commercial
hosting integrations are intentionally maintained outside this repository. The
...
and never includes workspace, provider, or other internal identifiers.
